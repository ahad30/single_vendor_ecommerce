...
const TopHeader = () => {
  return (
    <section className="mt-[-40px] mb-1">
      ...
      <MenuList placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}> 
          ...
          <div className="w-full">
            ...
            <form className="" action="">
              <input
                ...
                className="w-full bg-[#FEFBFB] px-4 outline-none rounded-3xl py-2 border-primary border-[0.5px] pe-10 shadow-sm sm:text-sm"
              />
            </form>

            <div className="absolute -end-2 bg-primary px-4 -top-0 bottom-0 flex justify-center items-center rounded-r-3xl  h-[38px]">
              <IoSearch
        ...
        <div className="flex gap-x-4 justify-center items-center">
          {/* love */}
          <div className="border-[#092635] p-1 border-[1px] rounded-full bg-[#0926351f]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
