      ...
      <div className="bg-white p-6 md:p-10 grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-10">
        <div className="flex flex-col justify-center items-center">
          <div className=" relative w-56 h-48 left-4 lg:mt-[-70px]">
            <img
              className="h-56 w-48  absolute object-cover"
          ...
          <div className="flex flex-col justify-center items-center bg-[#bdcef4] px-6 rounded-t-[30px] w-56 h-56">
            <h1 className="text-[#042656] mt-3 text-[20px] font-sans font-semibold">
              Sabiha Wasema
            </h1>
            ...
            <span className="text-[#555555] mt-1 text-sm font-normal font-mono">
              Email: sabihabitm1@gmail.com
            </span>
            <span className="text-[#555555] mt-1 text-sm font-normal font-mono">
              Mobile: +8801852787490
            </span>
          </div>
        </div>
        <div className="">
